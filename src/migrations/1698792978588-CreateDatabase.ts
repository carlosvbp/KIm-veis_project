...
export class CreateDatabase1698792978588 implements MigrationInterface {
    name = 'CreateDatabase1698792978588'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "schedules" ("id" SERIAL NOT NULL, "date" date NOT NULL, "hour" TIME NOT NULL, "userId" integer, "realstateId" integer, CONSTRAINT "PK_7e33fc2ea755a5765e3564e66dd" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "schedules" ADD CONSTRAINT "FK_057180bf98cc7bacebc03df2ca1" FOREIGN KEY ("realstateId") REFERENCES "realEstates"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "schedules" DROP CONSTRAINT "FK_057180bf98cc7bacebc03df2ca1"`);
